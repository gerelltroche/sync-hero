...
export default function CreateRoomForm({
  ...
  function handleNameSubmit(e) {
    e.preventDefault();
    const test = document.querySelector("#room");
    setRoomName(test.value);
  }
  ...
  return inCreatedRoom ? (
    <div className="flex flex-col justify-items-start border p-6">
      <div className="flex flex-row-reverse justify-between">
        <div className="tooltip" data-tip="Leave Room">
          <button className="btn btn-square" onClick={handleClearRoom}>
            <svg
    ...
    <form onSubmit={(e) => handleNameSubmit(e)} className="flex p-6">
